...
| 3.1 | `--shard`/`--merge` and `mclapply` | **closed** | serial and parallel byte-identical; merge refuses shards from different `R/` states, from a dirty tree, or an incomplete set |
